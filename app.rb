...
while body != "Exit"
  ...
  puts "What's on your mind? Press enter to Post, or type \"Refresh\" to refresh, \"Logout\" to logout of your current username, or \"Exit\" when finished.".green
  body = gets.chomp
  ...
  if body.capitalize == "Logout"
    File.delete("/Users/ebell/Code_Builders/Git_Hub_Work/soapbox/.soapbox")
    username = prompt_username
    next
  end
